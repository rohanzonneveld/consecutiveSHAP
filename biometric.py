...
# if str(pos_x_data.shape[1] - pruning_idx + 1) in os.listdir('experiments/biometric'):
#     print('Experiment already exists')
#     sys.exit()

print(f'#features={pos_x_data.shape[1] - pruning_idx + 1}')
print(f'max samples: {2**(pos_x_data.shape[1]-pruning_idx+1)}')

# select instances with different pruning indices for iteration over different number of players (one plot)
result = run_experiment(f_hs, pos_x_data, average_event, pruning_idx, show_plot=True)#, output_path='experiments/biometric')